...
6. Use the "up" and "down" arrow keys to control the brightness of the LED.  Use the "left" and "right" arrowkeys to move the Servo left and right.  Finally use the spacebar to centre the Servo.
